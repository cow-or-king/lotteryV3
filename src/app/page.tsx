      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
            ReviewLottery combine l'IA et la gamification pour augmenter votre nombre d'avis Google
            et fidéliser vos clients avec des campagnes de loterie personnalisées.
          </p>
