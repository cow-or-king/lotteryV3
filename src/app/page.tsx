 ...
 * Note: Next.js App Router gère les types de retour des pages
 */
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <main className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">ReviewLottery v3.0</h1>
        ...
        <div className="flex gap-4 justify-center">
          ...
          <div className="px-4 py-2 bg-blue-100 text-blue-800 rounded">Result Pattern ✓</div>
