  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-purple-600 to-pink-600 rounded-full mb-4 shadow-lg">
            ...
            <div className="flex-1">
              ...
              {isComplete ? (
                <>
                  ...
                  <button
                    onClick={onComplete}
                    className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-linear-to-r from-purple-600 to-pink-600 text-white font-bold text-lg rounded-xl hover:shadow-2xl transform hover:scale-105 transition-all"
                  >
                    <span>🎮</span>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-linear-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:shadow-lg transform hover:scale-105 transition-all"
              >
                Ouvrir Google Avis
              </button>
            </div>
