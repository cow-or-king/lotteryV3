    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="h-2 bg-white/70 backdrop-blur-xl rounded-full overflow-hidden border border-white/30">
          <div
            className="h-full bg-linear-to-r from-pink-500 to-purple-500 rounded-full transition-all duration-500"
      ...
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-pink-500 to-purple-600 rounded-full mb-4 shadow-lg">
          ...
          <div className="flex-shrink-0">
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-white text-lg shadow-lg ${
                hasClickedFollow ? 'bg-green-500' : 'bg-linear-to-br from-pink-500 to-purple-600'
              }`}
            >
              {hasClickedFollow ? '✓' : '📸'}
            </div>
          ...
          <div className="flex-1">
            ...
            {!hasClickedFollow ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-linear-to-r from-pink-500 to-purple-600 text-white font-bold text-lg rounded-xl hover:shadow-2xl transform hover:scale-105 transition-all"
              >
